...
def downsample_images(full_res_images, labels, initial_factor, final_factor = 2, lowest = False, full_res = False):
    ...
    if lowest:
        ...
        downsampled_images = 128*(tf.ones_like(images)[:,:h//final_factor,:w//final_factor,:])
